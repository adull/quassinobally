...
export const HOVERING_OVER = 'HOVERING_OVER'
...
export const SET_GAME_BTN_BG_COLOR = 'SET_GAME_BTN_BG_COLOR'
export const SET_GAME_BTN_TEXT_COLOR = 'SET_GAME_BTN_TEXT_COLOR'
export const SET_GAME_BTN_BORDER_COLOR = 'SET_GAME_BTN_BORDER_COLOR'
export const SET_GAME_BTN_BORDER_WIDTH = 'SET_GAME_BTN_BORDER_WIDTH'
export const SET_BACK_HOME_BTN_BG_COLOR = 'SET_BACK_HOME_BTN_BG_COLOR'
export const SET_BACK_HOME_BTN_TEXT_COLOR = 'SET_BACK_HOME_BTN_TEXT_COLOR'
